...
{
    public class PSPPayPalPaymentDTO : Payment
    {
        public string MerchantId { get; set; }

        public PSPPayPalPaymentDTO() : base() { }
        public PSPPayPalPaymentDTO(float amount, string name, string firstName, string lastName,
